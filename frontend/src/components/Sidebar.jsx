...
export default function Sidebar({ onPrompt }) {
  const { clearChat, sessions, currentSessionId, setCurrentSessionId, createNewSession, deleteSession, recentSearches } = useChat();
